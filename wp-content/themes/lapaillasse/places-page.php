 ...
 *
 * The template for displaying the places.
 *
...
get_header(); ?>
	...
	<div class="row">
		<header class="col-md-12" id="places-page-header">
			<h1>Les incarnations du réseau</h1>
			<p>Nous sommes légion</p>
		</header>
	</div>
	...
	<div class="row">
		<?php 
		$args = array( 'post_type' => 'lp_place', 'posts_per_page' => 10 );
