...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Download the file of userpro settings','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Just copy the export file data in to above text box and click on the import button','userpro'); ?></span>
		</td>
	</tr>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Download the file of userpro fields','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<p><input type="submit" name="import_fields" id="import_fields" class="button button-primary" value="<?php _e('Import','userpro'); ?>" /></p><span class="description"><?php _e('Just copy the export file data in to above text box and click on the import button','userpro'); ?></span>
		</td>
	</tr>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Download the file of userpro Field Groups','userpro'); ?></span>	
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<p><input type="submit" name="import_groups" id="import_groups" class="button button-primary" value="<?php _e('Import','userpro'); ?>" /></p><span class="description"><?php _e('Just copy the export file data in to above text box and click on the import button','userpro'); ?></span>
		</td>
	</tr>
