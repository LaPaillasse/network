...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This is typically your custom login page. Guests will be automatically redirected to this page If you block entire site for guests.','userpro'); ?></span>
		</td>
	</tr>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Please enter full web address to send users who access a restricted page. You can restrict any page/post by visiting it in post editor.','userpro'); ?></span>
		</td>
	</tr>
